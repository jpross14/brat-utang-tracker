...
export default function NewTransactionButton() {
   return (
    <DropdownMenu>
        <DropdownMenuTrigger className="group flex w-32 h-16 items-center pl-4 bg-white/75 backdrop-blur-xs shadow-soft-shine rounded-2xl space-x-3 ml-7 mt-10 active:brightness-75 hover:not-active:scale-105 transition-all">
        ...
        <DropdownMenuContent className="absolute top-3 w-48 h-24 *:text-lg *:blur-[0.75px] p-2 ">
